...
protected typeDefinitionInternal[mods]
...

{
    ...
    def enableAssert(self, shouldEnable):
        self.assertEnabled = shouldEnable
    /** Query the "assert" keyword state */
    def isAssertEnabled(self):
        return self.assertEnabled
    /** Enable the "enum" keyword */
    def enableEnum(self, shouldEnable):
        self.enumEnabled = shouldEnable
    /** Query the "enum" keyword state */
    def isEnumEnabled(self):
        return self.enumEnabled
}
