# $ANTLR 3.1.1 Java.g 2009-08-24 12:29:31
...
class JavaLexer(Lexer):
    ...
    def mHEX_LITERAL(self, ):
        ...
        try:
            ...
            # Java.g:1019:13: ( '0' ( 'x' | 'X' ) ( HEX_DIGIT )+ ( INTEGER_TYPE_SUFFIX )? )
            # Java.g:1019:15: '0' ( 'x' | 'X' ) ( HEX_DIGIT )+ ( INTEGER_TYPE_SUFFIX )?
            pass 
            self.match(48)
            ...
            # Java.g:1019:40: ( INTEGER_TYPE_SUFFIX )?
            alt2 = 2
    ...
    def mDECIMAL_LITERAL(self, ):
        ...
        try:
            ...
            # Java.g:1021:17: ( ( '0' | '1' .. '9' ( '0' .. '9' )* ) ( INTEGER_TYPE_SUFFIX )? )
            # Java.g:1021:19: ( '0' | '1' .. '9' ( '0' .. '9' )* ) ( INTEGER_TYPE_SUFFIX )?
            pass 
            # Java.g:1021:19: ( '0' | '1' .. '9' ( '0' .. '9' )* )
            alt4 = 2
            ...
            # Java.g:1021:46: ( INTEGER_TYPE_SUFFIX )?
            alt5 = 2
    ...
    def mOCTAL_LITERAL(self, ):
        ...
        try:
            ...
            # Java.g:1023:15: ( '0' ( '0' .. '7' )+ ( INTEGER_TYPE_SUFFIX )? )
            # Java.g:1023:17: '0' ( '0' .. '7' )+ ( INTEGER_TYPE_SUFFIX )?
            pass 
            self.match(48)
            # Java.g:1023:21: ( '0' .. '7' )+
            cnt6 = 0
            ...
            # Java.g:1023:33: ( INTEGER_TYPE_SUFFIX )?
            alt7 = 2
    ...
    def mHEX_DIGIT(self, ):
        ...
        try:
            # Java.g:1026:11: ( ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) )
            # Java.g:1026:13: ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )
            pass 
    ...
    def mFLOATING_POINT_LITERAL(self, ):
        ...
        try:
            ...
            # Java.g:1032:5: ( ( '0' .. '9' )+ ( DOT ( '0' .. '9' )* ( EXPONENT )? ( FLOAT_TYPE_SUFFIX )? | EXPONENT ( FLOAT_TYPE_SUFFIX )? | FLOAT_TYPE_SUFFIX ) | DOT ( '0' .. '9' )+ ( EXPONENT )? ( FLOAT_TYPE_SUFFIX )? )
            alt17 = 2
            ...
            if alt17 == 1:
                # Java.g:1032:9: ( '0' .. '9' )+ ( DOT ( '0' .. '9' )* ( EXPONENT )? ( FLOAT_TYPE_SUFFIX )? | EXPONENT ( FLOAT_TYPE_SUFFIX )? | FLOAT_TYPE_SUFFIX )
                pass 
                # Java.g:1032:9: ( '0' .. '9' )+
                cnt8 = 0
                while True: #loop8
                ...
                # Java.g:1033:9: ( DOT ( '0' .. '9' )* ( EXPONENT )? ( FLOAT_TYPE_SUFFIX )? | EXPONENT ( FLOAT_TYPE_SUFFIX )? | FLOAT_TYPE_SUFFIX )
                alt13 = 3
                ...
                if alt13 == 1:
                    # Java.g:1034:13: DOT ( '0' .. '9' )* ( EXPONENT )? ( FLOAT_TYPE_SUFFIX )?
                    pass 
                    self.mDOT()
                    # Java.g:1034:17: ( '0' .. '9' )*
                    while True: #loop9
                    ...
                    # Java.g:1034:39: ( FLOAT_TYPE_SUFFIX )?
                    alt11 = 2
                    ...
                    # Java.g:1035:13: EXPONENT ( FLOAT_TYPE_SUFFIX )?
                    pass 
                    self.mEXPONENT()
                    # Java.g:1035:22: ( FLOAT_TYPE_SUFFIX )?
                    alt12 = 2
                    ...
                    # Java.g:1036:13: FLOAT_TYPE_SUFFIX
                    pass 
                    self.mFLOAT_TYPE_SUFFIX()
                ...
                # Java.g:1038:9: DOT ( '0' .. '9' )+ ( EXPONENT )? ( FLOAT_TYPE_SUFFIX )?
                pass 
                self.mDOT()
                # Java.g:1038:13: ( '0' .. '9' )+
                cnt14 = 0
                ...
                # Java.g:1038:35: ( FLOAT_TYPE_SUFFIX )?
                alt16 = 2
    ...
    def mEXPONENT(self, ):
        ...
        try:
            # Java.g:1042:10: ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )
            # Java.g:1042:12: ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+
            pass 
    ...
    def mFLOAT_TYPE_SUFFIX(self, ):
        ...
        try:
            # Java.g:1045:19: ( ( 'f' | 'F' | 'd' | 'D' ) )
            # Java.g:1045:21: ( 'f' | 'F' | 'd' | 'D' )
            pass 
    ...
    def mCHARACTER_LITERAL(self, ):
        ...
        try:
            ...
            # Java.g:1048:5: ( '\\'' ( ESCAPE_SEQUENCE | ~ ( '\\'' | '\\\\' ) ) '\\'' )
            # Java.g:1048:9: '\\'' ( ESCAPE_SEQUENCE | ~ ( '\\'' | '\\\\' ) ) '\\''
            pass 
            self.match(39)
            # Java.g:1048:14: ( ESCAPE_SEQUENCE | ~ ( '\\'' | '\\\\' ) )
            alt20 = 2
            ...
            if alt20 == 1:
                # Java.g:1048:16: ESCAPE_SEQUENCE
                pass 
    ...
    def mSTRING_LITERAL(self, ):
        ...
        try:
            ...
            # Java.g:1052:5: ( '\"' ( ESCAPE_SEQUENCE | ~ ( '\\\\' | '\"' ) )* '\"' )
            # Java.g:1052:8: '\"' ( ESCAPE_SEQUENCE | ~ ( '\\\\' | '\"' ) )* '\"'
            pass 
            self.match(34)
            # Java.g:1052:12: ( ESCAPE_SEQUENCE | ~ ( '\\\\' | '\"' ) )*
            while True: #loop21
                alt21 = 3
                ...
                if alt21 == 1:
                    # Java.g:1052:14: ESCAPE_SEQUENCE
                    pass 
                    self.mESCAPE_SEQUENCE()
    ...
    def mESCAPE_SEQUENCE(self, ):
        ...
        try:
            # Java.g:1057:5: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UNICODE_ESCAPE | OCTAL_ESCAPE )
            alt22 = 3
            ...
            if alt22 == 1:
                ...
                # Java.g:1058:9: UNICODE_ESCAPE
                pass 
                self.mUNICODE_ESCAPE()


            elif alt22 == 3:
                # Java.g:1059:9: OCTAL_ESCAPE
                pass 
                self.mOCTAL_ESCAPE()
    ...
    def mOCTAL_ESCAPE(self, ):
        ...
        try:
            # Java.g:1064:5: ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) )
            alt23 = 3
    ...
    def mUNICODE_ESCAPE(self, ):
        ...
        try:
            # Java.g:1071:5: ( '\\\\' 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT )
            # Java.g:1071:9: '\\\\' 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT
            pass 
            self.match(92)
            self.match(117)
            self.mHEX_DIGIT()
    ...
    def mIDENT(self, ):
        ...
        try:
            ...
            # Java.g:1075:5: ( JAVA_ID_START ( JAVA_ID_PART )* )
            # Java.g:1075:9: JAVA_ID_START ( JAVA_ID_PART )*
            pass 
            self.mJAVA_ID_START()
            # Java.g:1075:23: ( JAVA_ID_PART )*
            while True: #loop24
                alt24 = 2
    ...
    def mJAVA_ID_START(self, ):
        ...
        try:
            # Java.g:1080:5: ( '\\u0024' | '\\u0041' .. '\\u005a' | '\\u005f' | '\\u0061' .. '\\u007a' | '\\u00c0' .. '\\u00d6' | '\\u00d8' .. '\\u00f6' | '\\u00f8' .. '\\u00ff' | '\\u0100' .. '\\u1fff' | '\\u3040' .. '\\u318f' | '\\u3300' .. '\\u337f' | '\\u3400' .. '\\u3d2d' | '\\u4e00' .. '\\u9fff' | '\\uf900' .. '\\ufaff' )
            # Java.g:
            pass 
    ...
    def mJAVA_ID_PART(self, ):
        ...
        try:
            # Java.g:1097:5: ( JAVA_ID_START | '\\u0030' .. '\\u0039' )
            # Java.g:
            pass 
    ...
    def mCOMMENT(self, ):
        ...
        try:
            ...
            # Java.g:1105:5: ( '/*' ( options {greedy=false; } : . )* '*/' )
            # Java.g:1105:9: '/*' ( options {greedy=false; } : . )* '*/'
            pass 
            self.match("/*")
            # Java.g:1105:14: ( options {greedy=false; } : . )*
            while True: #loop25
                alt25 = 2
